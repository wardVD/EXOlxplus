...
def function (lamb,ctau1,ctau2,phot):
    ...
    listsig1 = ["./v21_1phot/GMSB_L"+lamb+"-CTAU"+ctau1+".root"]
    listsig2 = ["./v21_1phot/GMSB_L"+lamb+"-CTAU"+ctau2+".root"]
    ...
    listfakehigh = ["./v21_2/Run2012Afakehigh.root","./v21_2/Run2012Bfakehigh.root","./v21_2/Run2012C_1fakehigh.root","./v21_2/Run2012C_2fakehigh.root","./v21_2/Run2012C_3fakehigh.root","./v21_2/Run2012D_1fakehigh.root","./v21_2/Run2012D_2fakehigh.root","./v21_2/Run2012D_3fakehigh.root"]
    listfakelow = ["./v21_2/Run2012Afakelow.root","./v21_2/Run2012Bfakelow.root","./v21_2/Run2012C_1fakelow.root","./v21_2/Run2012C_2fakelow.root","./v21_2/Run2012C_3fakelow.root","./v21_2/Run2012D_1fakelow.root","./v21_2/Run2012D_2fakelow.root","./v21_2/Run2012D_3fakelow.root"]
    ...
    """
    output = TFile.Open("./ctau"+ctau1+"andctau"+ctau2+"lambda"+lamb+"_1phot/output"+str(phot)+".root","recreate")
