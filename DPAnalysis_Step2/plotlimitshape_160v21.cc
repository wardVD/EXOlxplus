...
void plot_limit_mass(std::string LAMBDA){
  ...
  Double_t mTh[4] = {1.0,5.0,10.0,50.0};
  Double_t xsTh[4] = {xsec,xsec,xsec,xsec};

  Double_t x_pdf[8] = {1.0,5.0,10.0,50.0,50.0,10.0,5.0,1.0};
  ...
  TGraph* ul_lim_graph;
  ul_lim_graph  = new TGraph(4, mTh, obs_lim);
  ...
  c0->SaveAs("exclusion_limit_L160v21"+extra+".pdf");
