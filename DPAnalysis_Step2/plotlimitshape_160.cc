...
void plot_limit_mass(std::string LAMBDA){
  ...
  if ( LAMBDA=="160" ) {
    ...
    TTree * CT1000 = (TTree*)file_CT1000L160->Get("limit");
    TTree * CT2000 = (TTree*)file_CT2000L160->Get("limit");
  }
  ...
  Double_t mTh[6] = {1.0,5.0,10.0,50.0,100.0,200.0};
  Double_t xsTh[6] = {xsec,xsec,xsec,xsec,xsec,xsec};

  Double_t x_pdf[12] = {1.0,5.0,10.0,50.0,100.0,200.0,200.0,100.0,50.0,10.0,5.0,1.0};

  
  Double_t y_pdf_1sig[12] = { xsec*upperlimit10[1],
			     xsec*upperlimit50[1],
  ...
  c0->SaveAs("exclusion_limit_L160"+extra+".pdf");
